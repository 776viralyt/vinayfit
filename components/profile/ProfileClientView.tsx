...
import { User, Settings, Clock, Droplets, TrendingUp, Calendar, Camera, ChartBar as BarChart3, Target, ChevronRight, Activity, LogOut, Dumbbell, Apple } from 'lucide-react-native';
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.profileHeader}>
          ...
          <View style={styles.profileInfo}>
            ...
            <Text style={styles.profileRole}>Client Member</Text>
